...
public class Garmentdetails {
	...
	public static void main(String[] args) {
		...
		Garment g32=new Garment("jeansr",13,200,2600);
		Garment g42=new Garment("jacket",10,200,2000);
		...
		Garment g33=new Garment("jeans",13,200,2600);
		Garment g43=new Garment("jacket",10,200,2000);
...
//		Map<LocalDate,List<Garment>>e3=new HashMap<>();
		...
		List<Garment> result=check(test,e1,dates);
		System.out.println(result);

	}
	public static List<Garment> check(LocalDate test,Map<LocalDate, List<Garment>> e1,List<LocalDate> dates){
